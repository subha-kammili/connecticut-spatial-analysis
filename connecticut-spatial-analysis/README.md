...
- Compare the oldest and newest available time periods
- Visualize demographic patterns using choropleth maps
- Incorporate margins of error to represent uncertainty
...
2. Rename and standardize geographic fields.
3. Separate the oldest and newest available time periods.
4. Reshape each dataset from long to wide format.
5. Calculate and incorporate uncertainty using margins of error.
6. Join the cleaned datasets with Connecticut town-level shapefiles.
7. Create maps showing spatial patterns across Connecticut.
8. Compare changes between the earliest and latest periods.
...
Interested in Data Analytics, Data Engineering, Business Intelligence, and Technology.
